...
if(isset($_POST['y']) && strlen($_POST['y']) > 0 && isset($_POST['m']) && strlen($_POST['m']) > 0) {
    ...
    if(checkdate($m,1,$y)) {
        ...
        $count = $fc*7;
        $j=1;
        echo "<table border='1' width='500' bordercolor='#000000' style='border-collapse: collapse; border-width: 2px;'>";
        echo "<tr bgcolor='#E0F7FA' align='center'><td colspan='7'>". $y."년 ".$m."월 달력</td></tr>";
        echo "<tr align='center' bgcolor='#FFCCFF'><td>일</td><td>월</td><td>화</td><td>수</td><td>목</td><td>금</td><td>토</td></tr>";
